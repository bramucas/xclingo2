...
class TestXClingoPreprocessor:
    ...
    def expected_sup_body(self):
        ...
        expected_body = [
            ...
            ast.Literal(
                ...
                ast.SymbolicAtom(
                    ast.Function(
                        loc, "_xclingo_model", [ast.Function(loc, "hola", [], False)], False
                    )
                ),
            ),
            ast.Literal(
                ...
                ast.SymbolicAtom(
                    ast.Function(
                        loc, "_xclingo_model", [ast.Function(loc, "nothola", [], False)], False
                    )
                ),
            ),
            ast.Literal(
    ...
    def expected_fbody_body(self):
        ...
        expected_body = [
            ...
            ast.Literal(
                ...
                ast.SymbolicAtom(
                    ast.Function(
                        loc, "_xclingo_f_atom", [ast.Function(loc, "hola", [], False)], False
                    )
                ),
            ),
            ast.Literal(
    ...
    def custom_rule(self, custom_body):
        loc = ast.Location(ast.Position("", 0, 0), ast.Position("", 0, 0))
        lit = ast.Literal(loc, ast.Sign.NoSign, ast.SymbolicAtom(ast.Function(loc, "b", [], False)))
